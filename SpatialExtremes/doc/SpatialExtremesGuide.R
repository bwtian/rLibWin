...
###################################################
### code chunk number 1: SpatialExtremesGuide.Rnw:30-40
###################################################
...
###################################################
### code chunk number 2: SpatialExtremesGuide.Rnw:53-55
###################################################
...
###################################################
### code chunk number 3: SpatialExtremesGuide.Rnw:96-97 (eval = FALSE)
###################################################
...
###################################################
### code chunk number 6: SpatialExtremesGuide.Rnw:552-553
###################################################
par(mfrow=c(1,4), mar = c(4, 4, 0.2, 0.2))
covariance(nugget = 0, sill = 1, range = 1, smooth = 4, cov.mod = "whitmat",
           xlim = c(0,9), ylim = c(0, 1))
...
###################################################
### code chunk number 7: SpatialExtremesGuide.Rnw:606-617 (eval = FALSE)
###################################################
## covariance(nugget = 0, sill = 1, range = 1, smooth = 4, cov.mod = "whitmat",
##            xlim = c(0,9), ylim = c(0, 1))
## covariance(nugget = 0, sill = 1, range = 1, smooth = 2, cov.mod = "whitmat",
...
###################################################
### code chunk number 10: SpatialExtremesGuide.Rnw:682-683
###################################################
cov.fun <- covariance(nugget = 0, sill = 1, range = 1, smooth = 1,
                      cov.mod = "powexp", plot = FALSE)
phi <- pi / 4
...
###################################################
### code chunk number 12: SpatialExtremesGuide.Rnw:1005-1006 (eval = FALSE)
###################################################
## x <- y <- seq(0, 10, length = 100)
## coord <- cbind(x, y)
## seed <- 3
...
###################################################
### code chunk number 14: SpatialExtremesGuide.Rnw:1160-1161 (eval = FALSE)
###################################################
## x <- y <- seq(0, 10, length = 100)
## coord <- cbind(x, y)
## set.seed(8)
...
###################################################
### code chunk number 15: SpatialExtremesGuide.Rnw:1187-1189 (eval = FALSE)
###################################################
...
###################################################
### code chunk number 16: SpatialExtremesGuide.Rnw:1192-1196 (eval = FALSE)
###################################################
## x <- seq(0, 10, length = 100)
## coord <- cbind(x, x)
...
###################################################
### code chunk number 18: SpatialExtremesGuide.Rnw:1301-1302
###################################################
smith <- function(h) 2 * pnorm(h/2)
cov.fun <- covariance(nugget = 0, sill = 1, range = 1, smooth = 1, plot = FALSE)
schlather <- function(h)
...
###################################################
### code chunk number 20: SpatialExtremesGuide.Rnw:1405-1406
###################################################
n.site <- 40
n.obs <- 100
coord <- matrix(runif(2 * n.site, 0, 10), ncol = 2)
...
###################################################
### code chunk number 21: SpatialExtremesGuide.Rnw:1422-1431 (eval = FALSE)
###################################################
## n.site <- 40
## n.obs <- 100
## coord <- matrix(runif(2 * n.site, 0, 10), ncol = 2)
...
###################################################
### code chunk number 23: SpatialExtremesGuide.Rnw:1517-1518
###################################################
cov.fun1 <- covariance(nugget = 0, sill = 1, range = 1, smooth = 1,
                       cov.mod = "whitmat", plot = FALSE)
ext.coeff1 <- function(h)
...
###################################################
### code chunk number 24: SpatialExtremesGuide.Rnw:1550-1558 (eval = FALSE)
###################################################
## n.site <- 50
## n.obs <- 100
## coord <- matrix(runif(2 * n.site, 0, 10), ncol = 2)
...
###################################################
### code chunk number 26: SpatialExtremesGuide.Rnw:1595-1596
###################################################
n.site <- 40
n.obs <- 100
coord <- matrix(runif(2 * n.site, 0, 10), ncol = 2)
...
###################################################
### code chunk number 27: SpatialExtremesGuide.Rnw:1613-1619 (eval = FALSE)
###################################################
## n.site <- 40
## n.obs <- 100
## coord <- matrix(runif(2 * n.site, 0, 10), ncol = 2)
...
###################################################
### code chunk number 29: SpatialExtremesGuide.Rnw:1658-1659
###################################################
n.site <- 40
n.obs <- 100
coord <- matrix(runif(2 * n.site, 0, 10), ncol = 2)
...
###################################################
### code chunk number 30: SpatialExtremesGuide.Rnw:1742-1749 (eval = FALSE)
###################################################
## n.site <- 40
## n.obs <- 100
## coord <- matrix(runif(2 * n.site, 0, 10), ncol = 2)
...
###################################################
### code chunk number 32: SpatialExtremesGuide.Rnw:1897-1898
###################################################
n.site <- 40
n.obs <- 100
coord <- matrix(runif(2 * n.site, 0, 10), ncol = 2)
...
###################################################
### code chunk number 33: SpatialExtremesGuide.Rnw:1912-1921 (eval = FALSE)
###################################################
## n.site <- 40
## n.obs <- 100
## coord <- matrix(runif(2 * n.site, 0, 10), ncol = 2)
...
###################################################
### code chunk number 34: SpatialExtremesGuide.Rnw:1975-1981
###################################################
n.site <- 40
n.obs <- 80
coord <- matrix(runif(2*n.site, 0, 10), ncol = 2)
...
###################################################
### code chunk number 35: SpatialExtremesGuide.Rnw:2116-2123
###################################################
n.obs <- 80
n.site <- 40
set.seed(12)
...
###################################################
### code chunk number 36: SpatialExtremesGuide.Rnw:2144-2147 (eval = FALSE)
###################################################
...
###################################################
### code chunk number 37: SpatialExtremesGuide.Rnw:2153-2155 (eval = FALSE)
###################################################
...
###################################################
### code chunk number 38: SpatialExtremesGuide.Rnw:2159-2160 (eval = FALSE)
###################################################
## fitmaxstab(data, coord, cov.mod = "gauss")


###################################################
### code chunk number 39: SpatialExtremesGuide.Rnw:2166-2167 (eval = FALSE)
###################################################
## fitmaxstab(data, coord, cov.mod = "gauss", cov12 = 0, method = "BFGS")


###################################################
### code chunk number 40: SpatialExtremesGuide.Rnw:2339-2340
###################################################
set.seed(1)


###################################################
### code chunk number 41: SpatialExtremesGuide.Rnw:2343-2351
###################################################
n.obs <- 80
n.site <- 40
coord <- matrix(runif(2*n.site, 0, 10), ncol = 2)
...
###################################################
### code chunk number 42: SpatialExtremesGuide.Rnw:2417-2418
###################################################
set.seed(7)


###################################################
### code chunk number 43: SpatialExtremesGuide.Rnw:2421-2429
###################################################
n.obs <- 50
n.site <- 30
...
###################################################
### code chunk number 44: SpatialExtremesGuide.Rnw:2507-2508
###################################################
anova(M0, M1, method = "CB")


###################################################
### code chunk number 45: SpatialExtremesGuide.Rnw:2543-2546
###################################################
...
###################################################
### code chunk number 46: SpatialExtremesGuide.Rnw:2557-2558
###################################################
frech2gev(z, 1, 2, .2)


###################################################
### code chunk number 47: SpatialExtremesGuide.Rnw:2615-2616 (eval = FALSE)
###################################################
...
###################################################
### code chunk number 49: SpatialExtremesGuide.Rnw:2850-2851
###################################################
set.seed(12)
x <- runif(100)
fun <- function(x) sin(3 * pi * x)
...
###################################################
### code chunk number 50: SpatialExtremesGuide.Rnw:2867-2868 (eval = FALSE)
###################################################
## set.seed(12)
## x <- runif(100)
## fun <- function(x) sin(3 * pi * x)
...
###################################################
### code chunk number 52: SpatialExtremesGuide.Rnw:2893-2894
###################################################
M0 <- rbpspline(y, x, knots = knots3, degree = 3, penalty = 0)
M1 <- rbpspline(y, x, knots = knots3, degree = 3, penalty = 0.1)
M2 <- rbpspline(y, x, knots = knots3, degree = 3, penalty = 10)
...
###################################################
### code chunk number 53: SpatialExtremesGuide.Rnw:2926-2927 (eval = FALSE)
###################################################
## M0 <- rbpspline(y, x, knots = knots3, degree = 3, penalty = 0)
## M1 <- rbpspline(y, x, knots = knots3, degree = 3, penalty = 0.1)
## M2 <- rbpspline(y, x, knots = knots3, degree = 3, penalty = 10)
...
###################################################
### code chunk number 55: SpatialExtremesGuide.Rnw:3018-3019
###################################################
par(mfrow=c(1,3))
lambda.cv <- cv(y, x, knots = knots3, degree = 3)$penalty
abline(v = lambda.cv, lty = 2)
...
###################################################
### code chunk number 56: SpatialExtremesGuide.Rnw:3034-3035 (eval = FALSE)
###################################################
## par(mfrow=c(1,3))
## lambda.cv <- cv(y, x, knots = knots3, degree = 3)$penalty
## abline(v = lambda.cv, lty = 2)
...
###################################################
### code chunk number 57: SpatialExtremesGuide.Rnw:3111-3112
###################################################
set.seed(15)


###################################################
### code chunk number 58: SpatialExtremesGuide.Rnw:3115-3128
###################################################
n.site <- 20
n.obs <- 50
coord <- matrix(runif(2*n.site, 0, 10), ncol = 2)
...
###################################################
### code chunk number 59: SpatialExtremesGuide.Rnw:3133-3140
###################################################
loc.form <- y ~ lat
...
###################################################
### code chunk number 60: SpatialExtremesGuide.Rnw:3147-3149
###################################################
anova(M1, M2)
TIC(M1, M2)
